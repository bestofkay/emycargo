                        ...
                        <div class="intro-y box p-5">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <div class="absolute top-0 right-0 rounded-r w-10 h-full flex items-center justify-center bg-gray-100 border text-gray-600">email</div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="relative mt-2">
                                    <input type="text" name="phone_no" class="input pr-12 w-full border col-span-4" placeholder="Email Address">
                                    <div class="absolute top-0 right-0 rounded-r w-10 h-full flex items-center justify-center bg-gray-100 border text-gray-600">phone</div>
                                </div>
                            </div>
