...
class Home extends MY_Controller
{
	...
	public function index()
	{
		...
		{
			$this->data['pagetitle'] = 'Home | Management App';
			...
			if($user->active==0){
				...
				$this->session->set_flashdata('message', 'Oops! Account not active, contact administrator.');
				redirect('home/login', 'refresh');
			}
			if($user->userStaff == 'user'){
				$this->ion_auth->logout();
				$this->session->set_flashdata('message', 'Oops! You are not eligible to login, contact administrator.');
				redirect('home/login', 'refresh');
			}
			//Groups admin Belong to
